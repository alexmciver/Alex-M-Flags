Partial Class Default2
    ...
    Private Sub form1_Load(sender As Object, e As EventArgs) Handles form1.Load
        ...
        If RadioButton3.Text = RadioButton1.Text Or RadioButton2.Text Or RadioButton3.Text Then
            RadioButton3.Text = CountryNames(5 * Rnd())
        End If

        If RadioButton3.Text = RadioButton1.Text Or RadioButton2.Text = RadioButton3.Text Then
            RadioButton3.Text = CountryNames(5 * Rnd())
        End If
